...
# total visit budgets per sample size
visit_budget_map <- c(
  "200"  = 400,
  "300" = 600,
  "400"  = 800,
...
# prepare species data ----------> CHANGE SPECIES HERE:
species_data_study <- moose_studyarea
species_name <- "Moose"
...
# SCENARIO NAME
scenario_name <- "Baseline, occupancy (fixed total visits)"
scenario_ID <- "B11R"
...
run_one_sim <- function(species_data_study,
  ...
  # --- 1) sample unique cells (BASELINE: uniform) ---
...
saveRDS(
  scenario_perf,
  sprintf("saved/occupancy/baseline/%s_%s_scenario_summary_%s.rds",
